...
def football6():
    ...
    message = 'Голос учтен!\n Вторая битва титанов — МГУ против ВШЭ!'
    buttons = open("/home/jBloodless/mysite/football7.json", "r", encoding="UTF-8").read()
    return message, '', buttons


football6_command = command_system.Command()

football6_command.keys = ['no6']
football6_command.description = 'голосование за футбол'
football6_command.process = football6
