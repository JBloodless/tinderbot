...
def tinderFirstIterW():
    ...
    try:
        os.rename("/home/jBloodless/mysite/tinder/toA_{0}_{1}_{2}".format(sex_str, first_name, last_name), "/home/jBloodless/mysite/tinder/toW_{0}_{1}_{2}".format(sex_str, first_name, last_name))
    except (OSError, FileNotFoundError):
        try:
            os.rename("/home/jBloodless/mysite/tinder/toM_{0}_{1}_{2}".format(sex_str, first_name, last_name), "/home/jBloodless/mysite/tinder/toW_{0}_{1}_{2}".format(sex_str, first_name, last_name))
        except (OSError, FileNotFoundError):
            pass
    ...
    dislikes = '/home/jBloodless/mysite/tinder/toW_{0}_{1}_{2}/dislikes'.format(sex_str, first_name, last_name)
    likes = '/home/jBloodless/mysite/tinder/toW_{0}_{1}_{2}/likes'.format(sex_str, first_name, last_name)
    i=0
    ...
    #os.rename("/home/jBloodless/mysite/tinder/{0}_{1}_{2}".format(sex_str, user_name, user_surn), "/home/jBloodless/mysite/tinder/toW_{0}_{1}_{2}".format(sex_str, user_name, user_surn))
    ...
    #os.rename("/home/jBloodless/mysite/tinder/{0}_{1}_{2}".format(sex_str, first_name, last_name), "/home/jBloodless/mysite/tinder/toW_{0}_{1}_{2}".format(sex_str, first_name, last_name))

    return message, attachment, buttons


tinderFirstIterW_command = command_system.Command()

tinderFirstIterW_command.keys = ['С девушками']
tinderFirstIterW_command.description = 'internal tinder message'
tinderFirstIterW_command.process = tinderFirstIterW