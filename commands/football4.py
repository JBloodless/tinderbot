...
def football4():
    ...
    buttons = open("/home/jBloodless/mysite/football5.json", "r", encoding="UTF-8").read()
    return message, '', buttons


football4_command = command_system.Command()

football4_command.keys = ['no4']
football4_command.description = 'голосование за футбол'
football4_command.process = football4
