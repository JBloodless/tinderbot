...
def tinderFirstIterA():
    ...
    try:
        os.rename("/home/jBloodless/mysite/tinder/toW_{0}_{1}_{2}".format(sex_str, first_name, last_name), "/home/jBloodless/mysite/tinder/toA_{0}_{1}_{2}".format(sex_str, first_name, last_name))
    except (OSError, FileNotFoundError):
        try:
            os.rename("/home/jBloodless/mysite/tinder/toM_{0}_{1}_{2}".format(sex_str, first_name, last_name), "/home/jBloodless/mysite/tinder/toA_{0}_{1}_{2}".format(sex_str, first_name, last_name))
        except (OSError, FileNotFoundError):
            pass
    ...
    dislikes = '/home/jBloodless/mysite/tinder/toA_{0}_{1}_{2}/dislikes'.format(sex_str, first_name, last_name)
    likes = '/home/jBloodless/mysite/tinder/toA_{0}_{1}_{2}/likes'.format(sex_str, first_name, last_name)
    i=0
...
tinderFirstIterA_command = command_system.Command()

tinderFirstIterA_command.keys = ['Со всеми']
tinderFirstIterA_command.description = 'internal tinder message'
tinderFirstIterA_command.process = tinderFirstIterA